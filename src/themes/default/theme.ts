...
const colors = {
  dark: {
    ...
    inverse_on_surface: "#303030FF",
    inverse_primary: "#5E5E5EFF",
    inverse_surface: "#E2E2E2FF",
    on_background: "#E2E2E2FF",
    on_error: "#690005FF",
    on_error_container: "#FFDAD6FF",
    on_primary: "#1B1B1BFF",
    on_primary_container: "#000000FF",
    on_primary_fixed: "#FFFFFFFF",
    on_primary_fixed_variant: "#E2E2E2FF",
    on_secondary: "#1B1B1BFF",
    on_secondary_container: "#E2E2E2FF",
    on_secondary_fixed: "#1B1B1BFF",
    on_secondary_fixed_variant: "#3B3B3BFF",
    on_surface: "#E2E2E2FF",
    on_surface_variant: "#C6C6C6FF",
    on_tertiary: "#1B1B1BFF",
    on_tertiary_container: "#000000FF",
    on_tertiary_fixed: "#FFFFFFFF",
    on_tertiary_fixed_variant: "#E2E2E2FF",
    outline: "#919191FF",
    outline_variant: "#474747FF",
    primary: "#FFFFFFFF",
    primary_container: "#D4D4D4FF",
    primary_fixed: "#5E5E5EFF",
    primary_fixed_dim: "#474747FF",
    scrim: "#000000FF",
    secondary: "#C6C6C6FF",
    secondary_container: "#474747FF",
    secondary_fixed: "#C6C6C6FF",
    secondary_fixed_dim: "#ABABABFF",
    shadow: "#000000FF",
    source_color: "#AE9065FF",
    surface: "#131313FF",
    surface_bright: "#393939FF",
    surface_container: "#1F1F1FFF",
    surface_container_high: "#2A2A2AFF",
    surface_container_highest: "#353535FF",
    surface_container_low: "#1B1B1BFF",
    surface_container_lowest: "#0E0E0EFF",
    surface_dim: "#131313FF",
    surface_tint: "#C6C6C6FF",
    surface_variant: "#474747FF",
    tertiary: "#E2E2E2FF",
    tertiary_container: "#919191FF",
    tertiary_fixed: "#5E5E5EFF",
    tertiary_fixed_dim: "#474747FF",
  },
  light: {
    background: "#F9F9F9FF",
    error: "#BA1A1AFF",
    error_container: "#FFDAD6FF",
    inverse_on_surface: "#F1F1F1FF",
    inverse_primary: "#C6C6C6FF",
    inverse_surface: "#303030FF",
    on_background: "#1B1B1BFF",
    on_error: "#FFFFFFFF",
    on_error_container: "#410002FF",
    on_primary: "#E2E2E2FF",
    on_primary_container: "#FFFFFFFF",
    on_primary_fixed: "#FFFFFFFF",
    on_primary_fixed_variant: "#E2E2E2FF",
    on_secondary: "#FFFFFFFF",
    on_secondary_container: "#1B1B1BFF",
    on_secondary_fixed: "#1B1B1BFF",
    on_secondary_fixed_variant: "#3B3B3BFF",
    on_surface: "#1B1B1BFF",
    on_surface_variant: "#474747FF",
    on_tertiary: "#E2E2E2FF",
    on_tertiary_container: "#FFFFFFFF",
    on_tertiary_fixed: "#FFFFFFFF",
    on_tertiary_fixed_variant: "#E2E2E2FF",
    outline: "#777777FF",
    outline_variant: "#C6C6C6FF",
    primary: "#000000FF",
    primary_container: "#3B3B3BFF",
    primary_fixed: "#5E5E5EFF",
    primary_fixed_dim: "#474747FF",
    scrim: "#000000FF",
    secondary: "#5E5E5EFF",
    secondary_container: "#E2E2E2FF",
    secondary_fixed: "#C6C6C6FF",
    secondary_fixed_dim: "#ABABABFF",
    shadow: "#000000FF",
    source_color: "#AE9065FF",
    surface: "#F9F9F9FF",
    surface_bright: "#F9F9F9FF",
    surface_container: "#EEEEEEFF",
    surface_container_high: "#E8E8E8FF",
    surface_container_highest: "#E2E2E2FF",
    surface_container_low: "#F3F3F3FF",
    surface_container_lowest: "#FFFFFFFF",
    surface_dim: "#DADADAFF",
    surface_tint: "#5E5E5EFF",
    surface_variant: "#E2E2E2FF",
    tertiary: "#3B3B3BFF",
    tertiary_container: "#747474FF",
    tertiary_fixed: "#5E5E5EFF",
    tertiary_fixed_dim: "#474747FF",
  },
};
