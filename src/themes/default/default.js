...
/**
 * default theme — built by `npx astryx theme build`
...
export const defaultTheme = {
  ...
  tokens: {
    ...
    "--color-background-surface": "light-dark(#F9F9F9FF, #131313FF)",
    "--color-background-body": "light-dark(#F9F9F9FF, #131313FF)",
    "--color-background-card": "light-dark(#EEEEEEFF, #1F1F1FFF)",
    "--color-background-popover": "light-dark(#EEEEEEFF, #1F1F1FFF)",
    "--color-background-muted": "light-dark(#EEEEEEFF, #1F1F1FFF)",
    "--color-background-inverted": "light-dark(#303030FF, #E2E2E2FF)",
    "--color-accent": "light-dark(#000000FF, #FFFFFFFF)",
    "--color-accent-muted": "light-dark(#3B3B3BFF, #D4D4D4FF)",
    "--color-neutral": "light-dark(#0000000F, #FFFFFF1A)",
    "--color-overlay": "light-dark(#000000FF, #000000FF)",
    "--color-overlay-hover": "light-dark(#0000000D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#0000001A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#1B1B1BFF, #E2E2E2FF)",
    "--color-text-secondary": "light-dark(#474747FF, #C6C6C6FF)",
    "--color-text-disabled": "light-dark(#777777FF, #919191FF)",
    "--color-text-accent": "light-dark(#000000FF, #FFFFFFFF)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#E2E2E2FF, #1B1B1BFF)",
    "--color-on-success": "light-dark(#ffffff, #171717)",
    "--color-on-error": "light-dark(#FFFFFFFF, #690005FF)",
    "--color-on-warning": "light-dark(#E2E2E2FF, #1B1B1BFF)",
    "--color-icon-accent": "light-dark(#000000FF, #FFFFFFFF)",
    "--color-icon-primary": "light-dark(#1B1B1BFF, #E2E2E2FF)",
    "--color-icon-secondary": "light-dark(#474747FF, #C6C6C6FF)",
    "--color-icon-disabled": "light-dark(#777777FF, #919191FF)",
    "--color-success": "light-dark(#007004, #9fe59b)",
    "--color-success-muted": "light-dark(#c5e5c0, #84c9803D)",
    "--color-error": "light-dark(#BA1A1AFF, #FFB4ABFF)",
    "--color-error-muted": "light-dark(#FFDAD6FF, #93000AFF)",
    "--color-warning": "light-dark(#3B3B3BFF, #E2E2E2FF)",
    "--color-warning-muted": "light-dark(#747474FF, #919191FF)",
    "--color-border": "light-dark(#C6C6C6FF, #474747FF)",
    "--color-border-emphasized": "light-dark(#777777FF, #919191FF)",
    "--color-skeleton": "light-dark(#ebebeb, #525252)",
    "--color-shadow": "light-dark(#000000FF, #000000FF)",
